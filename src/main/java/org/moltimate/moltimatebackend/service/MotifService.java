                ...
                filteredAtoms.forEach(atom -> {
                    comparefilteredAtoms.forEach(compareAtom -> {
                        MotifSelection motifSelection = MotifSelection.builder()
                                ...
                                .residueName1(StructureUtils.residueName(atom.getGroup()))
                                .residueName2(StructureUtils.residueName(compareAtom.getGroup()))
                                .distance(StructureUtils.rmsd(atom, compareAtom))
                                .build();
